...
def derived_source_row(
    ...
    *,
    ...
    return {
        ...
        "remote_resolution_source": _text(row.get("remote_resolution_source")),
        "placeholder_relation_resolved": _text(row.get("placeholder_relation_resolved")),
        "quarantine_resolved_via_live_woo": _text(row.get("quarantine_resolved_via_live_woo")),
        "resolved_remote_key": _text(row.get("resolved_remote_key")),
        "resolved_woo_id": _text(row.get("resolved_woo_id")) or _text(row.get("combination_woo_id")),
        "resolved_parent_id": _text(row.get("resolved_parent_id")) or _text(row.get("combination_parent_woo_id")),
        "quarantine_group_ids": list(row.get("quarantine_group_ids") or []),
        "quarantine_reason": _text(row.get("quarantine_reason") or row.get("exclusion_reason")),
        "quarantine_status": _text(row.get("quarantine_status")),
        "worker_review_status": _text(row.get("worker_review_status")),
