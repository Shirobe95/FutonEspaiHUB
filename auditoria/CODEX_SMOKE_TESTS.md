...
| FUNC-003 / FUNC-003A supplier order profitability and canonical codes | Formula de margen de venta; rentabilidad global o individual; Coste Final real; equivalencia numerica con ceros iniciales en `item_id`, `heca_reference` y `hub_item_code`; prioridad exacta y bloqueo de ambiguedad | Pendiente | 2026-06-19 | FUNC-003 `2cb5939` / FUNC-003A `8499a6b` | Pendiente de smoke manual mediante `Abrir ERP.bat` | Confirmar guardar/recargar, cambio global sin sobrescribir individuales, pedido `0201001` contra item `201001`, RotC/precio automaticos, codigo visible/exportado intacto y bloqueo ambiguo |
...
Resultado actual tras FUNC-003A:
